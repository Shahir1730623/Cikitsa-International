...
class _DoctorVisaInvitationDetailsState extends State<DoctorVisaInvitationDetails> {
  ...
  Future<void> uploadFile(File file) async {
    firebase_storage.Reference reference = firebase_storage.FirebaseStorage.instance.ref('invitationImages/'+ selectedVisaInvitationInfo!.patientId! + "/medical_documents/Invitation_Letter.png" );
  ...
  void initState() {
    ...
    super.initState();
    futureFiles = firebase_storage.FirebaseStorage.instance.ref('invitationImages/'+ selectedVisaInvitationInfo!.patientId! + "/medical_documents").listAll();
  }
