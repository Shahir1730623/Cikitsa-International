...
import '../visa_invitation/visa_form_screen_2.dart';
import 'appointment_medical_document_form.dart';
        ...
        child: Scaffold(
          body: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Image.asset(
                  "assets/doctorAppointment/doctor-appointment-banner.jpg",
                ),
                          ...
                          onPressed: ()  async {
                            if (_formKey.currentState!.validate() && flag){
                              ...
                              Timer(const Duration(seconds: 5),()  {
                                Navigator.pop(context);
                                Navigator.push(context, MaterialPageRoute(builder: (context) => const AppointmentMedicalDocumentForm()));
                              });
                            }
